...
While we find no evidence for a positive feedback of summer warming that would trigger an abrupt shift in masting dynamics, it does not mean that climate change cannot lead to failures in tree recruitment and forest regeneration (since seed production is only the first step toward regeneration). It does suggest, however, that any observed declines must be driven by other factors. 
