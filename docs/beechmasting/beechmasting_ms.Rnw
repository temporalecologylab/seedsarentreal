...
More broadly, understanding changes in reproductive dynamics will require replacing masting within a wider life-cycle context. Seed production represents only the first step toward a successful forest regeneration, and climate change may lead into failures in seedling establishment and tree recruitment even in forests where seed production remains synchronous.
