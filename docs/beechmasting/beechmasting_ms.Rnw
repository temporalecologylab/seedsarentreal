...
However, even with a significant and continuous summer warming (+7degC in one century), only X\% of trees in a population would mast every year (Fig. \ref{fig:future}). 
