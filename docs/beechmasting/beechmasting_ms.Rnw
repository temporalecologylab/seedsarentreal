...
Despite the importance of synchrony to yielding fitness benefits from the phenomenon, we understand little of how it happens. Most hypotheses for how synchrony emerges focus on shared environmental cues at the species-level CITES. An abundance of work suggests that ideal conditions during bud formation---for example, sufficiently warm temperatures during the growing season when buds develop and no cold snaps (e.g., late spring frosts) that cause tissue loss after they form CITES---may lead to masting. % though these are rarely perfectly predictive, suggesting other cues may play a role (CITEsolstice). 
