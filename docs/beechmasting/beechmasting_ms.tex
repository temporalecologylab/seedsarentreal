...
% <!-- % \end{itemize} -->
Reproductive dynamics are impacted by climate. In a warm summer (23\celsius), trees in a low-reproduction state are 2 times (90\%CI 1.5-2.8) more likely to transition to a high-reproduction state than during cold summers (17\celsius, Fig. \ref{fig:climate}A). Once in a high-reproduction state, a three-fold increase of growing-degree days until last frost---a metric for late spring frost risk---can decrease seed production by -15.1\%  (90\%CI -23 to -6.4\%, Fig. \ref{fig:climate}B). However, warmer spring conditions have no effects on seed production (Supp. Fig.). 
