...
% <!-- % \end{itemize} -->
Reproductive dynamics are impacted by climate. In a warm summer (23$^\circ$C), trees in a low-reproduction state are 2 times (95\%CI 1.4-3) more likely to transition to a high-reproduction state than during cold summers (17$^\circ$C, Fig. \ref{fig:climate}A). Once in a high-reproduction state, a three-fold increase of growing-degree days until last frost---a metric for late spring frost risk---can decrease seed production by -18.5\%  (95\%CI -29.4 to -5.5\%, Fig. \ref{fig:climate}B). However, warmer spring conditions have no effects on seed production (Supp. Fig.). 
...
However, even with a significant and continuous summer warming ($+7^\circ$C in one century), only 56\%  (95\%CI 41.8 to 72.2\%) of trees in a population would mast in any given year (Fig. \ref{fig:future}). % change 'every year' to 'in any given year' because it's not always the same trees... Is it clearer now?
