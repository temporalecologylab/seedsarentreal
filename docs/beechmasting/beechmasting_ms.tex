...
% \end{itemize}
The apparent desynchronization of beech populations in the recent years is not always caused by the same scale. For example, 2018 was a year with a high uncertainty on tree reproductive states within populations, whereas in 2019 populations were desynchronized but trees in the same population were in the same state. [Discuss results...]
