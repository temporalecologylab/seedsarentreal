...
% \end{itemize}
Across beech populations in England, synchrony still appears to go down in the last two decades. The year 2006 was previously identified as a year of abrupt change, marked by a reproductive desynchronization. However, a lower degree of synchrony may mask distinct processes, and could be caused either from a desynchronization among trees within population or from desynchronization between populations. These two components matter for masting, because the evolutionary benefits of masting depend on the spatial scale at which trees reproduce synchronously --- and this scale in turn depends on the evolutionary hypothesis that we consider. o overwhelm seed predators,
