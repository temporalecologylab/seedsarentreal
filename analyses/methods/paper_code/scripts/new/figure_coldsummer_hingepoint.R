...
sm_gq <- stan_model(file = file.path(wd, "stan", "paper_models/new", "model2_treelevel_zinb_missing_rescaled_summertemp_springfrost_springtemp_wpred_standlevel.stan"))
