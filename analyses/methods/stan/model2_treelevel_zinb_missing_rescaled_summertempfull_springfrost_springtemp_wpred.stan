...
parameters {
  ...
  real<lower=0> beta_lambda2_spring; // Effect of spring temp. on masting intensity
...
model {
  ...
  beta_lambda2_frost ~ normal(0, log(1.3) / 2.57); # 20% relative change
  beta_lambda2_spring ~ normal(0, log(1.3) / 2.57); # 20% relative change
